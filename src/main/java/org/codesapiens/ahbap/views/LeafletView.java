...
public class LeafletView extends VerticalLayout {
     ...
     * UI-Components
     */
    private final Button btnLunch = new Button("En çok yardım gereken bölgeyi bul");
    private final Button btnCenter = new Button("Benim konumumu göster");
    private LMap map;
    ...
    public LeafletView(GeoLocation geoLocation) {
        ...
        this.btnCenter.addClickListener(e -> map.setCenter(
                        new LCenter(
    ...
    private void btnLunchClick(final ClickEvent<Button> event) {
        ...
        this.btnLunch.setText(this.viewLunch ? "Standart görünüme geç" : "En çok yardım gereken bölgeyi bul");
    }
